...
/** 物理《逆轉勝》，依使用者提供的目錄與末頁 p.255。 */
export const PHYSICS_COMEBACK_PAGE_MAP: readonly LecturePageMapRow[] = [
  [3, 3, '單元1 科學的態度與方法', '主題1 科學的態度與方法'],
  [4, 5, '單元1 科學的態度與方法', '主題2 國際單位制（SI制）'],
  [6, 13, '單元1 科學的態度與方法', '主題3 物理學發展簡史'],
  [14, 19, '單元2 物體的運動', '主題1 運動的描述'],
  [20, 29, '單元2 物體的運動', '主題2 等加速運動'],
  [30, 32, '單元3 牛頓運動定律', '主題1 常見的接觸力'],
  [33, 40, '單元3 牛頓運動定律', '主題2 牛頓運動三定律'],
  [41, 54, '單元3 牛頓運動定律', '主題3 克卜勒行星運動三定律'],
  [55, 57, '單元4 物質的組成', '主題1 原子觀點看世界'],
  [58, 61, '單元4 物質的組成', '主題2 拉塞福的原子模型'],
  [62, 72, '單元4 物質的組成', '主題3 基本粒子'],
  [73, 75, '單元5 基本交互作用', '主題1 重力'],
  [76, 80, '單元5 基本交互作用', '主題2 電磁力'],
  [81, 96, '單元5 基本交互作用', '主題3 強核力與弱核力'],
  [97, 101, '單元6 電與磁的統一', '主題1 電流磁效應'],
  [102, 107, '單元6 電與磁的統一', '主題2 電磁感應'],
  [108, 119, '單元6 電與磁的統一', '主題3 電與磁的統整'],
  [120, 129, '單元7 波動與光學', '主題1 波動的基本性質'],
  [130, 137, '單元7 波動與光學', '主題2 反射與折射'],
  [138, 140, '單元7 波動與光學', '主題3 折射的應用'],
  [141, 144, '單元7 波動與光學', '主題4 干涉'],
  [145, 146, '單元7 波動與光學', '主題5 繞射'],
  [147, 148, '單元7 波動與光學', '主題6 惠更斯原理'],
  [149, 169, '單元7 波動與光學', '主題7 都卜勒效應'],
  [170, 173, '單元8 功與能量', '主題1 功與功率'],
  [174, 180, '單元8 功與能量', '主題2 力學能'],
  [181, 182, '單元8 功與能量', '主題3 絕對溫標與熱功當量'],
  [183, 185, '單元8 功與能量', '主題4 微觀尺度下的能量'],
  [186, 188, '單元8 功與能量', '主題5 能量間的轉換與能量守恆'],
  [189, 193, '單元8 功與能量', '主題6 質能互換與核反應'],
  [194, 211, '單元8 功與能量', '主題7 核能發電與輻射安全'],
  [212, 215, '單元9 量子現象', '主題1 黑體輻射'],
  [216, 222, '單元9 量子現象', '主題2 光電效應與光量子論'],
  [223, 227, '單元9 量子現象', '主題3 物質波'],
  [228, 242, '單元9 量子現象', '主題4 波耳的氫原子模型'],
  [243, 249, '素養導向進階試題', '題型1 探究實作'],
  [250, 255, '素養導向進階試題', '題型2 跨科整合'],
];
